...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorObject> handleClientNotFoundException(ClientNotFoundException ex, HttpServletRequest request) {
        ErrorObject error = new ErrorObject(HttpStatus.NOT_FOUND, ex.getMessage(), request.getRequestURI());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error);
    }

    @ExceptionHandler(TypeContractNotFoundException.class)
    public ResponseEntity<ErrorObject> handleTypeContractNotFoundException(TypeContractNotFoundException ex, HttpServletRequest request) {
        ErrorObject error = new ErrorObject(HttpStatus.NOT_FOUND, ex.getMessage(), request.getRequestURI());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error);
    }
}